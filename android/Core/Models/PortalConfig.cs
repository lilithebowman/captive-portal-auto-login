...
public sealed class PortalConfig
{
	...
	/// <summary>
	/// HTML name/id attribute values tried when locating the username field.
	/// </summary>
	...
	/// <summary>
	/// HTML name/id attribute values tried when locating the password field.
	/// </summary>
	...
	/// <summary>
	/// When true, the app scans for open Wi-Fi access points and attempts to join them.
	/// Requires ACCESS_FINE_LOCATION and CHANGE_WIFI_STATE permissions on Android.
	/// </summary>
